...
create index IX_408B3B6C on cds_evaluation_periods (is_modified);
...
create index IX_47460738 on cds_performance_appraisals (root_id);
...
create index IX_FC49A031 on lmis_email_settings (email_type);

...
public class DeleteQuestionAction extends PortletAction{
	@Override
	public void processAction(ActionMapping mapping, ActionForm form,
			PortletConfig config, ActionRequest req, ActionResponse res)
			throws Exception {
		System.out.println("delete question action");
		...
		try {
			...
			ProGateJournalArticleLocalServiceUtil.deleteProGateJournalArticleFAQ(Integer.valueOf(articleId));			
			request.setAttribute("DELETE_SUCCESS", "Bạn đã xóa câu hỏi thành công.");	
			setForward(req, "portlet.SupportOrgProfile.addQuestion");
			return;
		} catch (Exception e) {
			// TODO: handle exception
			request.setAttribute("DELETE_ERROR", "Đã có lỗi xảy ra trong quá trình xóa câu hỏi.");

...
public class RepairNewsAction extends PortletAction {
	...
	public void processAction(ActionMapping mapping, ActionForm form,
		...
		String backURL = ParamUtil.getString(request, URLParameter_RS.BACK_URL,
				"");
		...
		try {
			...
			if (article != null) {
				System.out.println("Bạn đã cập nhập tin tức thành công.");
				...
				System.out
						.println("Đã có lỗi xảy ra trong quá trình cập nhập tin tức.");
				String title = (String) request.getParameter("title");
				request.setAttribute("CHANGE_TITLE", title);

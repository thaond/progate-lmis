	...
	public void doView(RenderRequest req, RenderResponse res)
		...
		try {
			...
			if (orgId != null) {
				...
				List<ProGateJournalArticle> listArticles = ProGateJournalArticleLocalServiceUtil.getListProGateArticlesByPrority(Integer.valueOf(orgId), articleType, true, "",0, 5);

...
public class ConfigPermissionAction extends ParameterizableViewAction {
	...
	public void handleActionRequestInternal(ActionRequest request,
		...
		for (int i = 0; i < listPerId.length; i++) {
			...
			System.out.println("----------------------------------------------------------------------luu thanh cong khong "+a);
		}
	}
	...
	public void handleRenderRequestInternal(RenderRequest request,
		...
		String appName = LmisConst.App_Name;
		int appId = LmisConst.App_Id; // id of Lmis application
		int categoryId = LmisConst.Pers_Att; // attendance info module
		...
		//String role=null;
		int IdOfUser=0;// id of user who manage this function 
		String cmd=ParamUtil.getString(request, Constants.CMD,"hello");
		bean.put("cmd",cmd);
		...
		String updateAttPer = LmisConst.Update_Permission_Att;
		String authorizedAttPer = LmisConst.Authorized_Att;
		int updateAttPermission = ViewOrgUsersPermissionsLocalServiceUtil.checkUserSpecialPermission(appName, category, rootId, IdOfUser,  updateAttPer);
		int authorizedAttPermission = ViewOrgUsersPermissionsLocalServiceUtil.checkUserSpecialPermission(appName, category, rootId, IdOfUser,  authorizedAttPer);
		System.out.println("--------------------DEBUG PERMISSION--------------------");
		System.out.println(updateAttPermission);
		System.out.println(authorizedAttPermission);
		System.out.println("--------------------DEBUG PERMISSION--------------------");
		bean.put("updatePermission", updateAttPermission);
		bean.put("authorizedPermission", authorizedAttPermission);
		String defaultTab = LmisRequest.TAB_BUILDING_PERMIT_1;
		if(updateAttPermission==0 && authorizedAttPermission !=0){
		...
		bean.put("delegatePer", LmisConst.Authorized_Att);
	}

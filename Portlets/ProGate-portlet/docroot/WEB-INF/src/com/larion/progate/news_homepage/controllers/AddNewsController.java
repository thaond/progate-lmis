...
public class AddNewsController extends
	...
	protected void handleActionRequestInternal(ActionRequest request,
			...
			if (mark != null){
				article = ProGateJournalArticleLocalServiceUtil.createNews(Integer.toString(0), userId, title, articleType, description, content, smallImagePath, "", true, "");
			}else{
				article = ProGateJournalArticleLocalServiceUtil.createNews(Integer.toString(0), userId, title, articleType, description, content, smallImagePath, "", false, "");
			}

...
public class Functions {
	...
	public static String getStaffCodeByUserId(int orgId,int userId){
		try{
			String staff = LmisGeneralSettingsLocalServiceUtil.getStaffCodeByUID(orgId, userId);
			return staff;
		}catch (Exception e) {
			// TODO: handle exception
			return null;
	...
	public static double getDayOffHavePermission(int userId,int month,int year,int orgId){
		try{
			double num = Double.parseDouble(LmisGeneralSettingsLocalServiceUtil.caculateTotalDayOffHavePermission(userId, month, year, orgId));
			return num;
		}catch (Exception e) {
			// TODO: handle exception
			return -1;
	...
	public static double getDayOffDontHavePermission(int userId,int month,int year,int orgId){
		try{
			double num = Double.parseDouble(LmisGeneralSettingsLocalServiceUtil.caculateTotalDayOffDontHavePermission(userId, month, year, orgId));
			return num;
		}catch (Exception e) {
			// TODO: handle exception
			return -1;

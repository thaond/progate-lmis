...
<c:set value="${bean.viewMode }" var="viewMode"></c:set>
...
<div class="news-org">
	...
	<div class="foresee" style="margin-bottom: 5px;">
		<a id="deleteNews"
			style="text-decoration: none; cursor: pointer;"><img style="vertical-align: middle; cursor: pointer;"
			src="<%=request.getContextPath()%>/images/news_org/delete.png"
			width="25" height="25" onclick="deleteNews();" /> <fmt:message key="news.delete" />
		</a>&nbsp;&nbsp;
		<!--  
	...
	<div class="note-head" style="padding: 25px 10px 5px 15px;">
		<c:if test="${bean.addSuccess == 1 }">
			<div class="video-body-mes-success new-blog" id="mesSuccess">
				<div class="img-td" style="float: left;">
					<img alt="" src="/ProGate-portlet/images/success.png" width="20px"
						height="20px">
				</div>
				<div style="float: left; padding-top: 8px; padding-left: 5px;">
					<span class="tq-body-content-mes"> <c:choose>
							<c:when test="${bean.cmd == 1 }">
		...
		<c:if test="${bean.addSuccess == 2 }">
			<div class="video-body-mes-error new-blog" id="mesError1">
				<div class="img-td" style="float: left;">
	...
	<div align="left">
		<form style="padding-top: 15px;"
			...
			method="post" name="updateNews" enctype="multipart/form-data"
			id="updateNewsProGate">
			<input type="hidden" value="${article.primaryKey }"
				name="<%=News_Const.ARTICLE_ID%>" /> <input type="hidden"
				value="${bean.currentURL}" name="<%=News_Const.CURRENT_URL%>" />
			<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" class="addNews">
				<tr>
					<td class="label"><fmt:message key="news.title" /> (<font
						color="red">*</font>)</td>
					<td>
						<div class="box">
							<input type="text" name="<%=News_Const.TITLE%>" id="headerNews"
								maxlength="100" class="text" value="${article.title}" />
				...
				<tr>
					<td class="label"><fmt:message key="news.content" /> (<font
						color="red">*</font>)</td>
					<td>
						<div class="box blogContent">
							...
							<input name="<%=News_Const.CONTENT%>" id="contentNews"
								type="hidden" value="" />
				...
				<tr>
					<td class="label"><fmt:message key="news.keyword" />
					</td>
					<td>
						<div class="box">
							<div style="float: left;">
								<input type="text" name="<%=News_Const.KEY_WORD%>"
									id="keyword" class="text" maxlength="100" value="" />
								<script type="text/javascript">
				...
				<!-- 
								   ...
								   -->
				<tr>
					<td class="label"><fmt:message key="news.intro" /> (<font
						color="red">*</font>)</td>
					<td>
						<div class="box">
							<div style="float: left;">
								<textarea name="<%=News_Const.DESCRIPTION%>" id="description"
									maxlength="300" COLS=40 ROWS=6> <c:out
				...
				<tr>
					<td class="label"><fmt:message key="news.image" /> (<font
						color="red">*</font>)</td>
					<td>
						<div class="news-org-img-border" align="center">
							<img id="smallImageDisplay" alt="" src="${article.smallImageUrl}"/>
						</div>
						<div style="width: 534px; float: left;">
							<span> <input type="file" name="<%=News_Const.SMALL_IMAGE%>" id="smallImage" size="72" />
							</span>
						</div> <!-- <div style="padding-top: 5px; width: 654px; float: right;">
						...
						<div class="box"
							style="width: 534px; padding-top: 10px; text-align: justify;">
								<span id="checkSmallImage" style="display: none; clear: both;"
									class="error"></span>
							<img
								style="vertical-align: middle; float: left; padding-right: 5px; padding-bottom: 11px;"
								src="<%=request.getContextPath()%>/images/news_org/information.png"
								width="20" height="20" />
		...
		<div class="button-align">
			<div class="save-button"
				style="padding-left: 260px; padding-bottom: 10px">
				<button id="suatintuc" class="bt-form"
					style="height: 24px; width: 80px;">
					<font size="3pt" style="font-family: sans-serif; font-size: 13px;"><fmt:message
							key="news.save" />
					</font>
				</button>
			</div>
			<div class="cancel-button">
				<button class="bt-form" style="height: 24px; width: 80px;"
					onclick="backButton();">
					<font size="3pt" style="font-family: sans-serif; font-size: 13px;"><fmt:message
							key="news.cancel" />
					</font>
...
<div id="des" style="display: none">${article.content}</div>
<script type="text/javascript">
		...
		if (confirm('<fmt:message key="warning.confirm.delete"/>')) {
			var portletActionURL = 
				'<portlet:actionURL windowState="<%=WindowState.NORMAL.toString()%>">
					...
					<portlet:param name="<%=URLParameter_RS.VIEW_MODE%>" value="1"/>
				</portlet:actionURL>';

...
<%
	...
	try {
		...
		List<Region> orgCities = RegionLocalServiceUtil.getListRegionByCountryCode("VN");
	    ...
	    renderRequest.setAttribute("establishDate", "");
	    renderRequest.setAttribute("founder", "");
	    renderRequest.setAttribute("orgType", "");
	    renderRequest.setAttribute("orgSize", "");
	    renderRequest.setAttribute("website", "");
	    renderRequest.setAttribute("city", "");
	    renderRequest.setAttribute("address", "");
	    renderRequest.setAttribute("phone", "");	
	    
		if (orgId != null){
			try{
                //Quann comment
		       larion.progate.model.Organization org = null;
                org = larion.progate.service.OrganizationLocalServiceUtil.getOrgObjectFromOrgId(Integer.parseInt(orgId));
                //end Quann comment
				SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");	
				String establishDate = null;
				Date orgFounded = org.getOrgFounded();			
				if (orgFounded != null){
					establishDate = (String)sdf.format(orgFounded.getTime());
				}
				establishDate = (establishDate == null)? "" : establishDate;
				renderRequest.setAttribute("establishDate", establishDate);
				
				String founderList = org.getFounderList();
				founderList = (founderList == null)? "" : founderList;
				renderRequest.setAttribute("founder", founderList);
				...
				renderRequest.setAttribute("orgSize", orgSize);
				
				String website = org.getWebsite();
				website = (website == null)? "" : website;
				renderRequest.setAttribute("website", website);
...
<div class="header_repair">	
	<%=res.getString("repairscreen")%>
</div>	

<div  class="note_head" style="clear:both;">
...
method="post" name="informationOrg">
<TABLE BORDER="0" CELLSPACING="0" CELLPADDING="0" class="editor" >
	<tr>
    	<td class="label" width="145px"><%=res.getString("establishDate")%> (<font color="red">*</font>)</td>
    	<td width="535px">
    	  <div class="inputtype">
    	  
    	  	<INPUT type="text" name="f_date1" id="f_date1" class="inputtext" style="width:291px;" 
    ...
    <tr>
    	<td class="label">							    		
    		<%=res.getString("typeOfActivity")%> (<font color="red">*</font>)</td>
    	<td>
    		<div class="inputtype">	
    			<c:set var="currentOrgType" value="${orgType}" scope="page"></c:set>
    			<select id="orgType" name="orgType" class="select-field">
 			...
 			<div id="checkOrgType" style="display:none;clear:both;">
 			</div>								 								 						 			
 		</td>							 		
    </tr>
    <tr>
    	<td class="label"><%=res.getString("quantityOfMembers")%> (<font color="red">*</font>)</td>
    	<td>
    		 <div class="inputtype">		
   				<input type="text" name="orgSize" id="orgSize" maxlength="70" class="inputtext" 
    ...
    <tr>
    	<td class="label"><%=res.getString("founder")%> (<font color="red">*</font>)</td>
    	<td>
    		<div class="inputtype">
    		  		<input type="text" name="founder" id="founder" maxlength="70" class="inputtext" 
    		  			value="${founder}"/>
				</div>
				<div id="checkFounder" style="display:none;clear:both;">
				</div>								 					 										 								 			
 		</td>							 		
    </tr>
    
    <tr>
    	<td class="label"><%=res.getString("website")%> (<font color="red">*</font>)</td>
    	<td>
    		<div class="inputtype">
    			<input type="text" name="website" id="website" maxlength="70" class="inputtext" value="${website}"/>
    ...
    <tr>
    	...
    	<td>
    		<div class="inputtype">
    			<input type="text" name="country" id="country" maxlength="70" class="inputtext" 
    			       readonly="readonly" value="Việt Nam" />
				</div>			 								 			
 		</td>
    </tr>
    ...
    <tr>
    	...
    	<td>
    		<div class="inputtype">
    			<c:set var="currentCity" value="${city}" scope="page"></c:set>
				...
				<div id="checkCity" style="display:none;clear:both;">
			   </div>				 								 			
 		</td>
    </tr>
    ...
    <tr>
    	...
    	<td>
    		<div class="inputtype">
    			<input type="text" name="phone" id="phone" maxlength="100" class="inputtext" 
    				value="${phone}"/>
 	...
 	<tr>					 		
 		<td colspan="2">
 			<div class="div_registerH save_button">
    								   <button id="save_information" class="bt-form" style="height:24px;width:80px;"><font size="3pt" style="font-family: sans-serif; font-size: 13px;"><%=res.getString("save")%></font></button>
 	                            </div>
 	                             </form>
 	                              <form action="<%=hostAdd%>" name="ReturnInformationOrg" method="get">
  	                            <div class="div_registerH cancel_button">
     								   	<input type="hidden" id="orgId" name="orgId" value="${orgId}"/>
     								   	<input type="hidden" id="viewMode" name="viewMode" value="${viewMode}"/>
     								   	<button id="cancel_information" type="submit" class="bt-form" style="height:24px;width:80px;" onclick="submitForm(document.ReturnInformationOrg)"><font size="3pt" style="font-family: sans-serif; font-size: 13px;"><%=res.getString("cancel")%></font></button>
  	                            </div>
  	                          </form>     	                            
 		</td>							 		
 	</tr>				 		 	

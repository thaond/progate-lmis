...
<%
	...
	/*
	String url = "";
	if (request.getParameter(Customer_Const.URL) != null){
		url = request.getParameter(Customer_Const.URL);
	}
	*/
			...
			<div class="tq-body">
				...
				<div class="tq-td">
					<div class="cus-image" id="orgLogoDiv" style="display: block;"> 
						<img src="/ProGate-portlet/images/news_org/small_noImage.gif" id="orgLogoImg" onload="scaleImg(this, 145, 100)" style="display: none;">
					</div>
				</div>

		...
		<div class="tq-body">
			...
			<div class="tq-body">
				...
				<div class="orgMap-img">
					<img id="image-preview" class="img-subject fl" alt="" src="<%= imageMap %>" onLoad='scaleImg(this, 145, 100)'/>
				</div>
				<div class="tq-td-right">
					<input type="file" name="<%= OrgMap_Const.IMAGE_MAP %>" id="<%= OrgMap_Const.IMAGE_MAP %>" size="56" onchange="imagePreview('imageMap', 'image-preview')"/>

...
<form action="" name="frmManagerDayOffBy" id="frmManagerDayOffBy" method="post">
    ...
    <div style="padding:10px 0 0 50px;float:left">
    		...
    		<table class="table" >
    			<thead style="color:#ffffff" >
    				<tr>
						...
						<th width="23%"  scope="col"><fmt:message key="lmis.common.fullname"/> </th>
						<th width="25%"  scope="col"><fmt:message key="lmis.dayoff.type"/></th>
						<th width="12%" scope="col"><fmt:message key="lmis.dayoff.begin"/></th>	
						<th width="12%" scope="col"><fmt:message key="lmis.dayoff.end"/></th>
						<th width="15%" scope="col"><fmt:message key="lmis.common.status"/></th>			

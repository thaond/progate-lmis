...
<div class="successful" style="height: 220px; width: 200px; display:none; background:#FFF; z-index:51;">	
	...
	<div id="emailOK" style="font-weight: bold; position: relative; float: left; padding-left: 10px; font-weight: bold;	margin:-23px 0 0 50px;">
		Bạn đã cấu hình email thành công!
	</div>
</div>

		...
		<div class="div-seperator-small">
			...
			<div class="col-center">
				<div class="col-center-checkbox">
					<input id="chkSenderStaff" name="chkSenderStaff" type="checkbox" checked="checked" disabled="disabled" />
					<label style="vertical-align: 2px;"> <fmt:message key="lmis.config.email.sender" /> </label>&nbsp; 
					<input id="chkSenderBOD" name="chkSenderBOD" type="checkbox" checked="checked" disabled="disabled" />
					<label style="vertical-align: 2px;"><fmt:message key="lmis.config.email.bod" /> </label>&nbsp;
					<input id="chkSenderPM" name="chkSenderPM" type="checkbox" checked="checked" disabled="disabled" />
					<label style="vertical-align: 2px;"><fmt:message key="lmis.config.email.pm" /> </label>
				</div>
			</div>
			<div class="col-right"></div>
			<div id="clear-both"></div>

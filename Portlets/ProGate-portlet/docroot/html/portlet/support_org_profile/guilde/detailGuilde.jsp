...
<script type="text/javascript">
	jQuery(function(){	
		jQuery("#content-detail img").each(function(){
...
<div class="support-org">  
	 <div class="container">
	 	...
	 	<div id="guilde" class="support-distance">
	      	...
	      	<span class="header">
	      		<a href='${returnGeneralPath}&actionView=generalGuilde&pageNum=1' >
...
<script>
	jQuery("#content-detail").attr("style","margin-top:20px;text-align:justify;margin-right: 30px;");

...
<ul class="tabs ">
	<c:choose>
		<c:when test="${bean.activedTab == bean.TAB_EVALUATION_1}">
			<li><a href='${tab1}' class='actived'>Xem kết quả hiện tại</a></li>	
		</c:when>
		<c:otherwise>
			<li><a href='${tab1}'>Xem kết quả hiện tại</a></li>
		</c:otherwise>
	</c:choose>
	
	<c:choose>
		<c:when test="${bean.activedTab == bean.TAB_EVALUATION_2}">
			<li><a href='${tab2}' class='actived'>Chuẩn bị đánh giá</a></li>	
		</c:when>
		<c:otherwise>
			<li><a href='${tab2}'>Chuẩn bị đánh giá</a></li>
		</c:otherwise>
	</c:choose>

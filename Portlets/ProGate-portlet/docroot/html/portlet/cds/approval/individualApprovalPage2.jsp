	...
	<c:choose>
			...
			<c:when test="${bean.region == bean.TAB_APPROVAL_1_PAGE_2_REGION_2}">
				...
				<div class="prepend-top span-22" style="margin-left:10px;margin-bottom: 5px">
					<span style="font-size: 12pt; font-weight: bold;" id="">Phê duyệt</span>
				</div>
				<div class="clear"></div>
				...
				<div class="" style="padding:10px; -moz-border-radius: 5px;background-color: #EEFFDD;" >
					...
					<div class="clear"></div>
					<div class="right">	
					    <input type="button" onclick="savePointRating(true)" value="Phê duyệt" class="cds-btn" style="background-color: gray; cursor: default; margin-top: 10px" id="saveButton">	    

 ...
 <fmt:message key="add.news" bundle="${msg}" var="add" />
 <fmt:message key="delete.news" bundle="${msg}" var="delete" />
 <fmt:message key="repair.news" bundle="${msg}" var="repair" />
 <fmt:message key="save.news" bundle="${msg}" var="save" />

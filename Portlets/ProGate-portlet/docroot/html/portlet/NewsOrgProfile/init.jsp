...
<%
 ...
 // there for you to use.
  ...
  //ResourceBundle res = ResourceBundle.getBundle("content.NewsOrgProfile_vn", locale);
%>
...
<script type="text/javascript">
   <%@ include file="/js/newsOrgProfile.js" %>
</script>

<fmt:setBundle basename="content.NewsOrgProfile_vn" var="msg"></fmt:setBundle>
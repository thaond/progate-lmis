...
<fmt:message key="add.chatonline" bundle="${msg}" var="add" />
 <fmt:message key="delete.chatonline" bundle="${msg}" var="delete" />
 <fmt:message key="repair.chatonline" bundle="${msg}" var="repair" />
  <fmt:message key="save.chatonline" bundle="${msg}" var="save" />

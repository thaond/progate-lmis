 ...
 <fmt:message key="add.library" bundle="${msg}" var="add" />
 <fmt:message key="delete.library" bundle="${msg}" var="delete" />
 <fmt:message key="repair.library" bundle="${msg}" var="repair" />
 <fmt:message key="save.library" bundle="${msg}" var="save" />

...
<div class="news-org"> 
	...
	<!--  <h4 class="alt"><fmt:message key="news.event"/></h4>
		...
		<c:if test="${sum > 1}">
			<c:choose>
				<c:when test="${rowCounter.count == 1}">
					<h4 class="alt">Tin mới:</h4><div class="dot-line" style="width:592px "></div>		
						<ul class="detail-news">
							<li>
				...
				<c:when test="${rowCounter.count == 6}">
					<h4 class="alt" style="padding-top: 28px;">Các tin khác:</h4><div class="dot-line" style="margin-top: -39px;margin-left: 99px;width: 560px;">

		...
		<table id="tableReport" style="width: 910px;">
			<thead>
				<tr id="trCompetency">
					...
					<th style="width: 80px;" rowspan="3">Chức Vụ</th>
					<th style="width: 80px;" rowspan="3">Chức Danh</th>
					<th class="span-5" rowspan="3">Dự Án Theo Đợt</th>	
					...
					<c:when test="${employee.periodId == bean.selectedPeriod}">
						...
						<td class=" td-align-left">
							...
							<c:if test="${employee.isTitleUp == true}">
						 		<img src="/ProGate-portlet/images/cds/title-up.png" height="13px" title="Đã lên title"/>
							</c:if>
						</td>
						<td class=" td-align-left">
						<script> 

...
<%@ page import="com.larion.progate.cds.constant.RequestConst" %>

<script>   
   <%@ include file="/js/cds/jquery.simplemodal.js" %>
</script>

<style type="text/css">
   <%@ include file="/css/cds/blueprint/screen.css" %>
   <%@ include file="/css/cds/blueprint/plugins/tabsplugin/screen.css" %>

   <%@ include file="/css/cds/cds-style.css" %>
</style>
...
<%
	...
	if(request.getParameter(Video_Const.EDITED_SUCCESS) != null){
		editSuccess = Integer.parseInt(request.getParameter(Video_Const.EDITED_SUCCESS));
	}
...
<form name="frmAdd" method="post" onsubmit="Javascript: return false;" action="<portlet:actionURL><portlet:param name='struts_action' value='/video/edit_video'></portlet:param></portlet:actionURL>">
	...
	<div class="video-layout">
		...
		<div class="video-body">
			<div class="tr-header">
				<div style="float: right; padding-top: 11x; display: none;"><span style="float: left;padding-top: 10px" class="body-content">Xem trước</span></div>
				<div class="img-td" style="float: right; display: none;"><img alt="" src="/ProGate-portlet/images/preview.png" width="30px" height="25px"/></div>
				...
				<div class="img-td" style="float: right;padding-top: 10px; padding-right: 9px"></div>
				<div class="img-td" style="float: right;padding-right: 2px;"><img alt="" src="<%=request.getContextPath()%>/images/news_org/delete.png" width="23px" height="23px" id="popup" style="vertical-align: middle; margin-left: 3px"/>
				<span> Xoá </span>

...
<form action="" name="frmRequestOTDetail" method="post">
	...
	<div class="cls-ot">
		...
		<div class="content-right">
			<div class="date-ot">
				<span style="padding-right:5px"><fmt:message key="lmis.overtimeReport.reportDayLower"/></span><input class="reportDate" type="text" name="reportDate" value="${bean.currDate}" width="456px" disabled="disabled"/>
			</div>

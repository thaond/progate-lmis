...
<form action="" name="frmSumReport" id="frmSumReport" method="post">
	<div class="content">
		...
		<div class="tableContainer" style="overflow:auto">
			<table class="table" style="overflow-y:auto;overflow-x:hidden;width:200%" >
				<thead style="color:#ffffff">
					<tr>
	    				...
	    				<th width="100px">Tổng<br/>Giờ Thưởng/Phạt</th>
	    			</tr>
    					...
    					<c:choose>
							...
							<c:otherwise>
								<tr class="evenrow">
									...
									<td class="cls-stt-right">${functions:getDetailSummayReportInt(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,1)}</td>
									<td class="cls-stt-right">${functions:getDetailSummayReportInt(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,2)}</td>
									<td class="cls-stt-right">${functions:getDetailSummayReportInt(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,3)}</td>			
									<td class="cls-stt-right">${functions:getDetailSummayReportDouble(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,1)}</td>
									<td class="cls-stt-right">${functions:getDetailSummayReportDouble(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,2)}</td>
									<td class="cls-stt-right">${functions:getDetailSummayReportInt(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,4)}</td>
									<td class="cls-stt-right">${functions:getDetailSummayReportDouble(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,3)}</td>
									<td class="cls-stt-right">${functions:getDetailSummayReportDouble(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,5)}</td>
									<td class="cls-stt-right">${functions:getDetailSummayReportDouble(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,6)}</td>
									<td class="cls-stt-right">${functions:getDetailSummayReportDouble(items.userId,bean.fromMonth,bean.toMonth,bean.year,bean.orgId,7)}</td>

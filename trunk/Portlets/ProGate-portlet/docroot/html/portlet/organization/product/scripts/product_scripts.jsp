...
<script type="text/javascript">
	...
	function initEditor() {
		...
		var out = document.frmProduct.productContent.value;
		
	    window.productContentEditor.setHTML(out);
	    
		return document.frmProduct.productConten.value;
	}
	
	function getHtmlValue() {
	    var html = window.productContentEditor.getHTML();	    
	}
	...
	function validate() {
		...
		var product_content_val = jQuery.trim(window.productContentEditor.getHTML());
		document.frmProduct.productContent.value = product_content_val;

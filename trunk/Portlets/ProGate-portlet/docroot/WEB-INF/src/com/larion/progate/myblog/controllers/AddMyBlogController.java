...
public class AddMyBlogController extends
	...
	protected void handleActionRequestInternal(ActionRequest request,
			...
			if (mark != null){
				article = ProGateJournalArticleLocalServiceUtil.createNews(Integer.toString(-1), userId, title, articleType, description, content, smallImagePath, "", true, "");
			}else{
				article = ProGateJournalArticleLocalServiceUtil.createNews(Integer.toString(-1), userId, title, articleType, description, content, smallImagePath, "", false, "");
			}

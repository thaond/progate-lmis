...
public class ProGateUtil {
	...
	public static void setRolesToBean(int loginUserId, int rootOrgId,
		...
		for (ProGateRoles proGateRoles : rolesofUserInSelectedOrg) {
			...
			if (ProgateRoleConst.ORG_MANAGER.equals(proGateRoles.getName())) {
				isOrgManager = true;
			}

			if (ProgateRoleConst.ORG_ADMIN.equals(proGateRoles.getName())) {
				isOrgAdmin = true;
			}

			if (ProgateRoleConst.ORG_STAFF.equals(proGateRoles.getName())) {
				isOrgStaff = true;
			}
		}
		...
		for (ProGateRoles proGateRoles : rolesofUserInRootOrg) {
			...
			if (ProgateRoleConst.ORG_OWNER.equals(proGateRoles.getName())) {
				isRootOrgOwner = true;
			}
			...
			if (ProgateRoleConst.ORG_MEMBER.equals(proGateRoles.getName())) {

package com.larion.progate.certificationMgmt.constants;
...
public interface RequestConst {	
	...
	public static final String BEAN = "certList";	
	
	public static final String ACTION = "action";	
	public static final String CERT_ID = "cId";	
	public static final String ACTION_STATUS = "actionStatus";
	
	public static final String ADD_CERT = "add";
	public static final String EDIT_CERT = "edit";
	public static final String DELETE_CERT = "del";

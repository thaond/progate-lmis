...
public class ReportDayOffController extends ParameterizableViewController {
	...
	protected ModelAndView handleRenderRequestInternal(RenderRequest request,
		...
		try{
			...
			List<LmisAbsenceSettings> lsNameAb = LmisAbsenceRequestsLocalServiceUtil.getListAbsenceOfRootId(orgId);
			System.out.println("-------------------------loai ngay nghi: "+ lsNameAb);
			bean.put("lsNameAb",lsNameAb);
		...
		bean.put("TAB_DAYOFF", Request.TAB_DAYOFF);
